...
use FDevs\CRUDBundle\Entity\Book;
use FDevs\CRUDBundle\Form\BookType;
...
class BookController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FDevsCRUDBundle:Book')->findAll();

        return $this->render('FDevsCRUDBundle:Book:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('FDevsCRUDBundle:Book:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FDevsCRUDBundle:Book')->find($id);
        ...
        return $this->render('FDevsCRUDBundle:Book:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('FDevsCRUDBundle:Book:edit.html.twig', array(
            'entity'      => $entity,
